...
namespace EncuestasCandidatosv2.Controllers
{
    public class PlacesController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Place,NA_State,NA_City,NA_Region")] Place place)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Place,NA_State,NA_City,NA_Region")] Place place)
        {
            if (ModelState.IsValid)
            {
