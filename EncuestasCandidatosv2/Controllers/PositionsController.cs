...
namespace EncuestasCandidatosv2.Controllers
{
    public class PositionsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ID_Position,NA_Position")] Position position)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ID_Position,NA_Position")] Position position)
        {
            if (ModelState.IsValid)
            {
